...
def odstrani_presledke(niz):
    if niz == '':
        return ''
    if niz[0] == ' ':
        return odstrani_presledke(niz[1:])
    else:
        return niz[0] + odstrani_presledke(niz[1:])
# =====================================================================@020115=
# 4. podnaloga
...
def odstrani_ponovljene_presledke(niz):
    if len(niz) <= 1:
        return niz
    if niz[0] == ' ' and niz[1] == ' ':
        return odstrani_ponovljene_presledke(niz[1:])
    else:
        return niz[0] + odstrani_ponovljene_presledke(niz[1:])
...
#     ['041123457', '051123457']
# =============================================================================
def ustreza(stevilo, regex):
    if stevilo == '':
        return True
    if regex[0] == '*':
        return ustreza(stevilo[1:], regex[1:])
    return stevilo[0] == regex[0] and ustreza(stevilo[1:], regex[1:])

def najdi_stevilko(vzorec, seznam):
    if seznam == []:
        return []
    stevilo = seznam[0]
    if ustreza(stevilo, vzorec):
        return [stevilo] + najdi_stevilko(vzorec, seznam[1:])
    else:
        return najdi_stevilko(vzorec, seznam[1:])
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0Ijo5NzczfQ:1j8p3g:hQ8IvdxTXHnq1ajb00aAJTffPtE'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0Ijo5Nzc0fQ:1j8p3g:-YJDD4pQDiWRkKmcsh_DyIhfVbY'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0Ijo5NzcyfQ:1j8p3g:IundEPA5Zz10PWfugagCiUy3fKs'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoyMDExNX0:1j8p3g:48uPr30e6fUEA8gkz-qKM3VxPg0'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoyMDExNH0:1j8p3g:dd8dV2bmagdk05fjemdwKeC900Q'
        try:
