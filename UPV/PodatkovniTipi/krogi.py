...
def v_preseku(x0, y0, krogi):
    ...
    x, y, r = krogi[0]
    if (x - x0) ** 2 + (y - y0) ** 2 <= r ** 2:
        return v_preseku(x0, y0, krogi[1:])
    else:
        return False
# =====================================================================@001313=
# 3. podnaloga
...
def pravokotnik(krogi):
    ...
    if len(krogi) == 1:
        ...
        other_x_min, other_y_min, other_x_max, other_y_max = pravokotnik(krogi[1:])
        return (
            min(x_min, other_x_min),
            min(y_min, other_y_min),
            max(x_max, other_x_max),
            max(y_max, other_y_max)
        )
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoxMzExfQ:1j8pPn:ASLQLWdnRzfSPs7Ogh7ko-k7Tco'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoxMzEyfQ:1j8pPn:6591jKigmV8ISzrVuzMDZGxhtgw'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoxMzEzfQ:1j8pPn:CWN8bHfvV5-FJxXKlXEFiBmgMzc'
        try:
