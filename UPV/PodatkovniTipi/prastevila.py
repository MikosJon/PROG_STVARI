...
#     True
# =============================================================================
def je_deljivo_s_katerim_od(stevilo, seznam):
    if seznam == []:
        return False
    return stevilo % seznam[0] == 0 or je_deljivo_s_katerim_od(stevilo, seznam[1:])
# =====================================================================@009810=
# 2. podnaloga
...
#     [2, 3, 5, 7]
# =============================================================================
def prastevila_do(stevilo):
    if stevilo <= 1:
        return []
    manjsa_prastevila = prastevila_do(stevilo - 1)
    if je_deljivo_s_katerim_od(stevilo, manjsa_prastevila):
        return manjsa_prastevila
    else:
        return manjsa_prastevila + [stevilo]
# =====================================================================@009811=
# 3. podnaloga
# Definirajte funkcijo `je_prastevilo`, ki vrne ali je število praštevilo.
# =============================================================================
def je_prastevilo(stevilo):
    return stevilo >= 2 and not je_deljivo_s_katerim_od(stevilo, list(range(2, stevilo)))
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0Ijo5ODA5fQ:1j8ouP:hWUgiqf0Vj4rDkG8gdVhNOoDa5Q'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0Ijo5ODEwfQ:1j8ouP:YHygAKwgZW5LzZJvDvRFsoWeDO4'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0Ijo5ODExfQ:1j8ouP:Clg3OHI9sEhxfH9J4pH9P5uxOqk'
        try:
