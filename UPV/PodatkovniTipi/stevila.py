...
def odrezi_stevko(n):
    if n % 10 == n:
        return 0
    return 10 * odrezi_stevko(n // 10) + n % 10
# =====================================================================@024172=
# 2. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoyNDE3MX0:1j8pa3:l3oE8NDiZG8hPNeoCmTb4IC5yWw'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoyNDE3Mn0:1j8pa3:ifbQSrK4rj851IzM9erLDueFGZc'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoyNDE3M30:1j8pa3:0TAzx9v-OLbSvtP_xKJHZRMSDRg'
        try:
