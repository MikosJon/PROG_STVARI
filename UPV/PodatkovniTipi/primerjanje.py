...
def vecji_element(seznam, stevilo):
    ...
    if stevilo < seznam[0]:
        ...
        return vecji_element(seznam[1:], stevilo)
# =====================================================================@013129=
# 2. podnaloga
...
def prvi_najvecji(seznam):
    if seznam == []:
        return True
    return not vecji_element(seznam[1:], seznam[0])
# =====================================================================@013132=
# 3. podnaloga
...
def vsi_vecji(seznam1, seznam2):
    if seznam1 == []:
        return True
    return not vecji_element(seznam2, seznam1[0]) and vsi_vecji(seznam1[1:], seznam2)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoxMzEyOH0:1j8okc:sWQ0ynBdARimoJfLp75hn3uioKE'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoxMzEyOX0:1j8okc:buK93Ve4wtZKc56Z24EuR4IogTU'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoxMzEzMn0:1j8okc:dC4gWh_RRSNgNOc2t7Z_64Lc8_A'
        try:
