...
def razbij_na_stevke(stevilo):
    return [int(znak) for znak in str(stevilo)]
# =====================================================================@013414=
# 2. podnaloga
...
def prestej_crke(geslo, niz):
    niz_v = niz.upper()
    geslo_v = geslo.upper()
    return [niz_v.count(znak) for znak in geslo_v]
# =====================================================================@013415=
# 3. podnaloga
...
#     87
# =============================================================================
def ujemanje(ime1, ime2, geslo='LOVES'):
    stevke = prestej_crke(geslo, ime1 + ime2)
    while len(stevke) > 2:
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoxMzQxM30:1jD7AU:DM6tUoTuHSfu-QZ6c8oNAMkEiqY'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoxMzQxNH0:1jD7AU:CrTIr3D_xwgizbuqf0M_FXRYJfo'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoxMzQxNX0:1jD7AU:BRCA-H5Fq6jTjU2OCUxPmtkvM0I'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoxMzQxNn0:1jD7AU:PFn8OQaT9KMVw7RVyfV3VnFdk9s'
        try:
