...
# =============================================================================
def naslednji_priblizek(priblizek):
    return 1 + 1 / priblizek
# =====================================================================@001001=
# 2. podnaloga
...
def natancni_priblizek(eps):
    ...
    priblizek = 1
    while True:
        prejsni_priblizek, priblizek = priblizek, naslednji_priblizek(priblizek)
        if abs(prejsni_priblizek - priblizek) < eps:
            return priblizek
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoxMDAwfQ:1jAsQs:ufwl7qHNGMAJRMW5HETWxrfw2u8'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoxMDAxfQ:1jAsQs:8tst51T__UgpeHEHBOVtsnsMAAE'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoxMDAyfQ:1jAsQs:0bRdukR1ubKmNOlc5pUwCxHtMtQ'
        try:
