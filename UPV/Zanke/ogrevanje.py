...
#     False
# =============================================================================
def vsebuje_niz_z_vprasajem(seznam):
    return any('?' in niz for niz in seznam)
# =====================================================================@020190=
# 3. podnaloga
...
#     False
# =============================================================================
def zgolj_dolge_besede(seznam, stevilo):
    return all(len(niz) >= stevilo for niz in seznam)
# =====================================================================@020191=
# 4. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoyMDE4OH0:1jAsLU:saXJQEiGYktiTZ0PcqCLHW-2Y_8'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoyMDE4OX0:1jAsLU:SIn-Wm_R23-zG0QGxEG0JbdYk9k'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoyMDE5MH0:1jAsLU:iKzkcHpeyjSNkU3FYdZ1uMBx_F8'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoyMDE5MX0:1jAsLU:x7tV0QUk7JVpbMiqxDlXjL4P7uU'
        try:
