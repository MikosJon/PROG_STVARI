...
def pripravi_primer(elementi, indeksi):
    return list(zip(elementi, indeksi))
# =====================================================================@020192=
# 2. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoyMDE5M30:1jAsQn:T2iKRqdR_bMae-MJSMa331gJdPI'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0IjoyMDE5Mn0:1jAsQn:3cYWxNP-i82qQ5SJcogLvkaqUQM'
        try:
