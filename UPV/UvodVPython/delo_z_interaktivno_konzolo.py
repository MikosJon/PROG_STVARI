...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0Ijo5MTB9:1j42yN:39RBuUx0eQMUq4tBq088tVvUQEM'
        try:
            try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0Ijo5MTF9:1j42yN:BC6gst3O3XypWZ0Z7D6cLmgDues'
        try:
            try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0Ijo5MTJ9:1j42yN:LBQLtVKvxNY5heVs4127GXcTqGw'
        try:
            try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0Ijo5MTN9:1j42yN:xx5qG1rsHEHs817zwzvxQpYaP4w'
        try:
            try:
