...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0Ijo5MDd9:1j42m5:7LXtxw2Kp-PV-IMTG9SoYZW3x7g'
        try:
            try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0Ijo5MDh9:1j42m5:_ARdkF4QnhEV8RFdUFmI3kMUK4s'
        try:
            try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MjcxLCJwYXJ0Ijo5MDl9:1j42m5:BDt9wdnIYjKCHqcabK0gZUQdz80'
        try:
            try:
